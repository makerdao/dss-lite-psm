...
contract DssLitePsm {
    ...
    function fill() public returns (uint256 wad) {
        return _doFill(_subCap(gemBalance * to18ConversionFactor, cash()));
    }
    ...
    function rush() public view returns (uint256 wad) {
        ...
        return _min(
            ...
            _subCap(gemBalance * to18ConversionFactor, cash()),
    ...
    function gush() public view returns (uint256 wad) {
        ...
        return _max(
            ...
            _subCap(_cash, gemBalance * to18ConversionFactor),
